...
<body class="container" data-ng-app="recipeApp"
	...
	<ul>
		...
		<li
			...
			{{recipe.recipeName}} | {{recipe.userAmount}}/{{recipe.items.length}}
			required item(s) | <a target="_blank"
			href="http://{{recipe.recipeUrl}}">{{recipe.recipeUrl}}</a>
			<table class="table table-bordered table-striped" id="recipe-table">
				...
				<tr>
					<td width="150px">{{recipe.recipeDescription}}</td>
