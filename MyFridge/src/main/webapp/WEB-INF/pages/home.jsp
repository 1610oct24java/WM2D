...
<body class="container" data-ng-app="myApp"
	...
	<table id=table class="table table-bordered table-striped">
		...
		<tbody>
			...
			<!-- attempt to send the new item to the controller form a form that is also table columns -->
			
			<%-- <form:form 
					action="addItem"
					method="POST"
					commandName="UserItem">
				<td><form:input type="text" path="itemId.itemName" /></td>
				<td><form:input type="number" path="measureAmount" /><form:input
					type="text" path="measureType" /></td>
				<td><form:input type="date" path="expirationDate" /></td>
				<td><form:input type="text" path="itemDetails" /></td>
				<td><button type="submit">Create Item</button></td>
			</form:form> --%>
			</tr>

			<tr data-ng-repeat="item in items | filter:searchItems">
...
<!-- Just trying to figure out how to send the new item to the controller... -->
			<form:form 
					action="addItem"
					method="POST"
					commandName="UserItem">
				<%-- <form:input type="text" path="itemId.itemName" /> --%>
				<form:input type="number" path="measureAmount" />
				<form:input type="text" path="measureType" />
				<form:input type="date" path="expirationDate" />
				<form:input type="text" path="itemDetails" />
